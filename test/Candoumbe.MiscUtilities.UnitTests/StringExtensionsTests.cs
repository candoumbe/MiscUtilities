...
public class StringExtensionsTests(ITestOutputHelper outputHelper)
{
    ...
    [Property]
    public void Given_source_is_not_null_When_search_is_empty_Then_FirstOccurrence_should_return_0(NonNull<string> sourceGenerator)
    {
        // Arrange
        string source = sourceGenerator.Item;
    ...
    public void Given_input_ToPascalCase_should_convert(string input, string expected)
    {
        // Act
